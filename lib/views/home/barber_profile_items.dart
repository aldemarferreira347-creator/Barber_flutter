...
List<ProfileMenuItem> buildBarberProfileItems(BuildContext context, AppUser? profile) {
  return [
    if (profile != null)
      ProfileMenuItem(
      ...
      ProfileMenuItem(
        ...
        onTap: () =>
            Navigator.of(context)
                .push(MaterialPageRoute(builder: (_) => ManageServicesView(barbershopId: profile!.barbershopId!))),
      ),
      ProfileMenuItem(
        icon: Icons.qr_code,
