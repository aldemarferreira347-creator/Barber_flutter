...
class AppColors {
  ...
  static Color get primary => isDark ? const Color(0xFF3B82F6) : const Color(0xFF0F172A);
  static Color get accent => isDark ? const Color(0xFF60A5FA) : const Color(0xFF3B82F6);
  static const success = Color(0xFF10B981);
  static const warning = Color(0xFFF59E0B);
  static const error = Color(0xFFEF4444);
  static Color get background => isDark ? const Color(0xFF0B1220) : const Color(0xFFF1F5F9);
  ...
  static Color get border => isDark ? const Color(0xFF2A3855) : const Color(0xFFE2E8F0);
}
